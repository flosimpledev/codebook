  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
        <div className="text my-5">
            <h1 className="text-5xl font-bold">Wholesome Movies for the Whole families</h1>
            <p className="text-2xl my-7 px-1 dark:text-slate-300">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Soluta eligendi aliquid optio hic quibusdam. Cum quod atque consequatur! Distinctio, aliquid.</p>
